    ...
    return (
        <>
            <div className='flex flex-row items-center'>
                <header className='font-bold text-3xl m-6 text-center mr-auto'>EIDE BAILLY SUITE LEVEL</header>
                <div className='flex flex-wrap'>
                    <button className='flex p-1 m-2 border-2 rounded text-xs font-bold'>
